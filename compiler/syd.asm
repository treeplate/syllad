...
.const
  typeTable    db 003h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 001h, 002h, 000h, 000h, 000h, 000h, 000h, 000h ; Type table
   ...
   ; 0 0   NullFunction(Integer...)'6
   ; 0 0   IntegerReadOnlyList'7
   ; 1 0   Integer'8
   ; 0 1   String'9
...
main:
  ...
  push 000000004h                                                ; value of argument #4
  push 000000008h                                                ; type of argument #4
  push 000000003h                                                ; value of argument #3
  push 000000008h                                                ; type of argument #3
  push 000000002h                                                ; value of argument #2
  push 000000008h                                                ; type of argument #2
  ...
  mov rcx, 4                                                     ; number of arguments
  sub rsp, 20h                                                   ; allocate shadow space
  call offset func$test                                          ; jump to subroutine
  add rsp, 068h                                                  ; release shadow space and arguments
...
func$test:
  ...
  func$test$varargTypeChecks$Loop:
    ...
    lea r10, typeTable                                           ; move type table offset into r10
    add rax, r10                                                 ; adjust rax to point to the type table
    bt qword ptr [rax], 0                                        ; check that vararg types is Integer'8
