...
.const
  typeTable    db 03fh, 010h, 010h, 010h, 010h, 010h, 010h, 010h, 010h, 010h, 010h, 010h, 010h, 030h, 010h, 010h, 010h, 030h, 011h, 012h, 014h, 018h, 000h, 000h ; Type table
  ...
  parameterCountCheckFailureMessage dq -01h                      ; String constant (reference count)
               dq 88                                             ; Length
               db "error: function call received the wrong number of parameters (expected %d, received %d)", 0ah ; line 1618 column 25 in file syd-compiler.syd
  ...
  parameterTypeCheckFailureMessage dq -01h                       ; String constant (reference count)
               dq 71                                             ; Length
               db "error: type mismatch for function %s parameter %d, expected %s, got %s", 0ah ; line 1623 column 25 in file syd-compiler.syd
               db 00h                                            ; padding to align to 8-byte boundary
  returnValueTypeCheckFailureMessage dq -01h                     ; String constant (reference count)
               dq 68                                             ; Length
               db "error: type mismatch for function return value, expected %s, got %s", 0ah ; line 1628 column 25 in file syd-compiler.syd
  ...
  operandTypeCheckFailureMessage dq -01h                         ; String constant (reference count)
               dq 54                                             ; Length
               db "error: type mismatch for operand, expected %s, got %s", 0ah ; line 1633 column 25 in file syd-compiler.syd
               db 00h, 00h                                       ; padding to align to 8-byte boundary
  asOperatorFailureMessage dq -01h                               ; String constant (reference count)
               dq 58                                             ; Length
               db "error: type mismatch for as operator, expected %s, got %s", 0ah ; line 1638 column 25 in file syd-compiler.syd
  ...
  boundsFailureMessage dq -01h                                   ; String constant (reference count)
               dq 64                                             ; Length
               db "error: subscript index out of range (%d is not in range %d..%d)", 0ah ; line 1643 column 25 in file syd-compiler.syd
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h, 00h         ; padding to align to 8-byte boundary
  ...
  string$2     dq -01h                                           ; String constant (reference count)
               dq 61                                             ; Length
               db "internal error: zero extra bytes but fromCursor is before end" ; line 61 column 90 in file runtime library
               db 00h, 00h, 00h                                  ; padding to align to 8-byte boundary
  string$3     dq -01h                                           ; String constant (reference count)
               dq 39                                             ; Length
               db "internal error: more than 7 extra bytes"      ; line 62 column 68 in file runtime library
               db 00h                                            ; padding to align to 8-byte boundary
  string$4     dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "0"                                            ; line 101 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$5     dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "1"                                            ; line 104 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$6     dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "2"                                            ; line 107 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$7     dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "3"                                            ; line 110 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$8     dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "4"                                            ; line 113 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$9     dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "5"                                            ; line 116 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$10    dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "6"                                            ; line 119 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$11    dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "7"                                            ; line 122 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$12    dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "8"                                            ; line 125 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$13    dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db "9"                                            ; line 128 column 14 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
  string$14    dq -01h                                           ; String constant (reference count)
               dq 56                                             ; Length
               db "Invalid digit passed to digitToStr (digit as exit code)", 0ah ; line 130 column 69 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h, 00h         ; padding to align to 8-byte boundary
  string$15    dq -01h                                           ; String constant (reference count)
               dq 0                                              ; Length
  string$16    dq -01h                                           ; String constant (reference count)
               dq 4                                              ; Length
               db "true"                                         ; line 154 column 19 in file runtime library
               db 00h, 00h, 00h, 00h                             ; padding to align to 8-byte boundary
  string$17    dq -01h                                           ; String constant (reference count)
               dq 5                                              ; Length
               db "false"                                        ; line 156 column 18 in file runtime library
               db 00h, 00h, 00h                                  ; padding to align to 8-byte boundary
  string$18    dq -01h                                           ; String constant (reference count)
               dq 4                                              ; Length
               db "null"                                         ; line 159 column 17 in file runtime library
               db 00h, 00h, 00h, 00h                             ; padding to align to 8-byte boundary
  string$19    dq -01h                                           ; String constant (reference count)
               dq 28                                             ; Length
               db "value cannot be stringified", 0ah             ; line 164 column 41 in file runtime library
               db 00h, 00h, 00h, 00h                             ; padding to align to 8-byte boundary
  string$20    dq -01h                                           ; String constant (reference count)
               dq 1                                              ; Length
               db " "                                            ; line 173 column 17 in file runtime library
               db 00h, 00h, 00h, 00h, 00h, 00h, 00h              ; padding to align to 8-byte boundary
...
main:
  ...
  add rsp, 040h                                                  ; release shadow space and arguments (result in stack pointer)
  mov rax, qword ptr [rsp + 018h]                                ; value initialization of variable declaration for ptr variable (_alloc return value)
  mov rbx, qword ptr [rsp + 010h]                                ; type initialization of variable declaration for ptr variable
  ; Line 4: __writeToAddress(ptr, -1);
  mov rsi, 001h                                                  ; assign value of 1 to value of - unary operator result
  neg rsi                                                        ; - unary operator
  mov rdi, 014h                                                  ; - unary operator result is of type Integer'20
  ...
  mov rcx, 014h                                                  ; + operator result is of type Integer'20
  ; Call _moveBytes with 3 arguments
  push 003h                                                      ; value of argument #3 (3)
  push 014h                                                      ; type of argument #3 (Integer'20)
  ...
  mov rbx, qword ptr [rsp + 010h]                                ; force cast of ptr variable to String
  mov rsi, 015h                                                  ; force cast of ptr variable to String is of type String'21
  ...
  add rsp, 040h                                                  ; release shadow space and arguments (result in stack pointer)
  ; Calling decref on force cast of ptr variable to String (static type: String'21)
...
func$_free:
  ...
  mov rsi, 013h                                                  ; value result of == (testing __heapFree return value and 0) is a Boolean'19
  ...
  mov rdi, 013h                                                  ; type result of == (testing __heapFree return value and 0) is a Boolean'19
...
func$_moveBytes:
  ...
  func$_moveBytes$while$top:                                     ; top of while
    ...
    ; Line 50: Integer value = __readFromAddress(fromCursor);
  ...
  je func$_moveBytes$if$continuation                             ; fromCursor < end
    ; Line 58: Integer newValue = __readFromAddress(fromCursor);
    ; Call __readFromAddress with 1 arguments
    ...
    ; Line 59: Integer oldValue = __readFromAddress(toCursor);
    ; Call __readFromAddress with 1 arguments
    ...
    ; Line 60: Integer extraBytes = end - fromCursor;
    ...
    ; Line 61: assert(extraBytes > 0, 'internal error: zero extra bytes but fro...
    ...
    call func$assert                                             ; jump to subroutine
    add rsp, 050h                                                ; release shadow space and arguments (result in stack pointer)
    ; Line 62: assert(extraBytes < 8, 'internal error: more than 7 extra bytes'...
    ...
    call func$assert                                             ; jump to subroutine
    add rsp, 050h                                                ; release shadow space and arguments (result in stack pointer)
    ; Line 63: Integer mask = -1 << extraBytes * 8;
    ...
    ; Line 64: Integer finalValue = newValue & ~mask | oldValue & mask;
    ...
    ; Line 65: __writeToAddress(toCursor, finalValue);
    ; Call __writeToAddress with 2 arguments
...
func$_stringByteLength:
  ...
  ; Line 70: Integer pointer = data __as__ Integer;
  ...
  ; Line 71: return __readFromAddress(pointer + 8);
...
func$concat:
  ...
  func$concat$while$top:                                         ; top of while
    ...
    ; Line 78: length += _stringByteLength(arguments[index]);
  ...
  ; Line 81: Integer resultPointer = _alloc(16 /* 0x10 */ + length);
  ...
  ; Line 82: __writeToAddress(resultPointer, 1);
  ; Call __writeToAddress with 2 arguments
  mov qword ptr [r13], 001h                                      ; __writeToAddress
  ; Line 83: __writeToAddress(resultPointer + 8, length);
  ...
  ; Line 84: Integer cursor = resultPointer + 16 /* 0x10 */;
  ...
  func$concat$while$top$1:                                       ; top of while
    ...
    ; Line 87: String segment = arguments[index];
    ...
    ; Line 88: Integer segmentLength = _stringByteLength(segment);
    ; Call _stringByteLength with 1 arguments
    ...
    je func$concat$while$if$continuation                         ; segmentLength > 0
      ; Line 90: Integer segmentPointer = segment __as__ Integer;
      ...
      ; Line 91: _moveBytes(segmentPointer + 16 /* 0x10 */, cursor, segmentLength...
  ...
  ; Line 96: return resultPointer __as__ String;
...
func$digitToStr:
  ...
  ; Line 130: __print('Invalid digit passed to digitToStr (digit as exit code)...
  ; Call __print with 1 arguments
...
func$intToStr:
  ...
  ; Line 139: Integer newValue = value;
  ...
  func$intToStr$while$top:                                       ; top of while
    ...
    ; Line 141: Integer digit = newValue % 10 /* 0xa */;
    ...
    ; Line 142: newValue = newValue / 10 /* 0xa */;
    ...
    ; Line 143: buffer = concat(digitToStr(digit), buffer);
...
func$_stringify:
  ...
  je func$_stringify$if$continuation                             ; arg is String
    ...
    jne func$_stringify$Stringify$if$block$AfterIncref
    ...
    js func$_stringify$Stringify$if$block$AfterIncref            ; if ref count is negative (constant strings), skip incref
    ...
    func$_stringify$Stringify$if$block$AfterIncref:              ; after incref
    jmp func$_stringify$epilog                                   ; return
  func$_stringify$if$continuation:                               ; end of if
  ; Line 152: if (arg is Boolean) { ...
  ...
  je func$_stringify$if$continuation$3                           ; arg is Integer
    ; Line 162: return intToStr(arg as Integer);
    mov r15, qword ptr [rbp + 038h]                              ; move type of arg to testByte
    mov rax, r15                                                 ; move testByte to testByte
    mov r10, 001h                                                ; read operand of mul (type table width in bytes) 
    mul r10                                                      ; adjust to the relative start of that type's entry in the type table
  ...
  ; Line 164: __print('value cannot be stringified\n');
  ; Call __print with 1 arguments
...
func$print:
  ...
  func$print$while$top:                                          ; top of while
    ...
    ; Line 175: __print(_stringify(parts[index]));
...
func$println:
  ...
  func$println$varargTypeChecks$Loop:                            ; top of loop
    ...
    mov rax, qword ptr [rsp + 040h]                              ; restoring slots to previous scope state
  ; Line 182: Boolean first = true;
  mov rbx, 001h                                                  ; value initialization of variable declaration for first variable (true)
  mov rsi, 013h                                                  ; type initialization of variable declaration for first variable (Boolean'19)
  ; Line 183: Integer index = 0;
  mov rdi, 000h                                                  ; value initialization of variable declaration for index variable (0)
  mov rax, 014h                                                  ; type initialization of variable declaration for index variable (Integer'20)
  func$println$while$top:                                        ; top of while
    ...
    ; Line 188: __print(_stringify(parts[index]));
